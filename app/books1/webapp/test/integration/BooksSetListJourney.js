...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheBooksSetList.onFilterBar().iCheckFilterField("ID");
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheBooksSetList.onTable().iCheckColumns(undefined, {"ID":{"header":"ID"},"Title":{"header":"Title"},"author":{"header":"author"},"publishdate":{"header":"publishdate"},"digitalCopy":{"header":"digitalCopy"}});
